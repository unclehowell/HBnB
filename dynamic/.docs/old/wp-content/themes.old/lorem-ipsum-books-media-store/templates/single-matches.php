...
if ( !function_exists( 'lorem_ipsum_books_media_store_template_single_matches_theme_setup' ) ) {
	add_action( 'lorem_ipsum_books_media_store_action_before_init_theme', 'lorem_ipsum_books_media_store_template_single_matches_theme_setup', 1 );
	function lorem_ipsum_books_media_store_template_single_matches_theme_setup() {
		lorem_ipsum_books_media_store_add_template(array(
			'layout' => 'single-matches',
			'mode'   => 'matches',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single matches', 'lorem-ipsum-books-media-store'),
...
// Template output
if ( !function_exists( 'lorem_ipsum_books_media_store_template_single_matches_output' ) ) {
	function lorem_ipsum_books_media_store_template_single_matches_output($post_options, $post_data) {
