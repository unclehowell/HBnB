...
class config {
    ...
    function __construct(){
        $this->data = array(
            'lang'=>'',
            'fm_root'=>'/var/www/html/docs/edit/HotspotBnB/docs',
            'timezone'=>'',
...
function dir_list_form() {
    ...
    function edit_file_form(arg){
        openModalWindow('".addslashes($fm_path_info["basename"])."?action=7&fm_current_dir=".rawurlencode($fm_current_dir)."&filename='+encodeURIComponent(arg),'".et('')." ".addslashes($fm_current_dir)."'+(arg));
    }
    ...
    function execute_entry(arg){
        if(confirm('".et('ConfExec')." \\''+arg+'\\' ?')) {
            openModalWindow('".addslashes($fm_path_info["basename"])."?action=11&fm_current_dir=".rawurlencode($fm_current_dir)."&filename='+encodeURIComponent(arg),'".et('')." '+(arg));
        }
    }
    ...
    function get_breadcrumbs($path){
        ...
        if (strlen($uplink)) $uplink = "<a href=\"https://docs-cms.hotspotbnb.com\" target=\"_top\"> Login/Edit </a> To view PDF's visit build/latex/ OR visit build/html and 'View' index.html to preview in HTML";
        ...
        if($entry_count){
            ...
            foreach ($entry_list as $ind=>$dir_entry) {
                ...
                if ($dir_entry["type"] == "dir") {
                    ...
                    if ($has_files) $dir_out[$dir_count][] = "<td class=\"sm\"><nobr></td>";
                    // Directory Actions
            ...
            if ($file_count) $out .= "
                  <th><nobr><a href=\"".$fm_path_info["basename"]."?frame=3&or_by=$or6&fm_current_dir=".rawurldecode($fm_current_dir)."\">".et('')."</a></nobr></th>";
            if ($file_count) $out .= "
        ...
        <div style=\"-ms-transform:scale(1.5); transform: scale(1.5) translate(0, 50px);\">
            <form name=\"chmod_form\">
                ...
                <table cellpadding=\"2\" cellspacing=\"0\" border=\"0\" align=center>
                    ...
                    <tr bgcolor=\"#DDDDDD\">
                        <td width=\"60\" align=\"left\" nowrap bgcolor=\"#FFFFFF\">".et('')."</td>
    ...
    <div id=\"div_toolbar\">
        ...
        <form name=\"portscan_form\" action=\"".$fm_path_info["basename"]."\" method=\"get\" target=\"portscanIframe\">
            ...
            <tr><td valign=top width=1>
                ...
                <button type=\"button\" class=\"btn\" onclick=\"execute_portscan()\" value=\"".et('')."\"><i class=\"fa fa-refresh\"></i> ".et('')."</button>
