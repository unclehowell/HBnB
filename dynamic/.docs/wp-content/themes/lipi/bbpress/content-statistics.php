...
<dl role="main">
	...
	<?php if ( !empty( $stats['empty_topic_tag_count'] ) ) : ?>
		...
		<dt><?php _e( 'Empty Topic Tags', 'lipi' ); ?></dt>
		<dd>
	...
	<?php if ( !empty( $stats['topic_count_hidden'] ) ) : ?>
		...
		<dt><?php _e( 'Hidden Topics', 'lipi' ); ?></dt>
		<dd>
			<strong>
	...
	<?php if ( !empty( $stats['reply_count_hidden'] ) ) : ?>
		...
		<dt><?php _e( 'Hidden Replies', 'lipi' ); ?></dt>
		<dd>
			<strong>
