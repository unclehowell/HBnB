/**
 * Lorem Ipsum Books & Media Store Framework: Utilities
 *
		...
		case "object":
			if (mixed_val == null)
				...
				for (var i=0; i<mixed_val.length; i++) {
					idxobj.idx++;
					var ser = lorem_ipsum_books_media_store_serialize(mixed_val[i]);
					if (ser)
						map.push(lorem_ipsum_books_media_store_serialize(idxobj.idx) + ser);
				}                                      
				return "a:" + mixed_val.length + ":{" + map.join("") + "}";
			} else {
				var class_name = lorem_ipsum_books_media_store_get_class(mixed_val);
				if (class_name == undefined)
					return false;
				var props = new Array();
				for (var prop in mixed_val) {
					var ser = lorem_ipsum_books_media_store_serialize(mixed_val[prop]);
					if (ser)
						props.push(lorem_ipsum_books_media_store_serialize(prop) + ser);
				}
				if (obj_to_array)
...
function lorem_ipsum_books_media_store_get_class(obj) {
	"use strict";
...
function lorem_ipsum_books_media_store_in_list(str, list) {
	"use strict";
...
function lorem_ipsum_books_media_store_alltrim(str) {
	"use strict";
...
function lorem_ipsum_books_media_store_padr(str, len) {
	"use strict";
	var ch = arguments[2] ? arguments[2] : ' ';
	var rez = str.substr(0,len);
	if (rez.length < len) {
...
function lorem_ipsum_books_media_store_padc(str, len) {
	"use strict";
	var ch = arguments[2] ? arguments[2] : ' ';
	var rez = str.substr(0,len);
	if (rez.length < len) {
...
function lorem_ipsum_books_media_store_replicate(str, num) {
	"use strict";
	var rez = '';
	for (var i=0; i<num; i++) {
		rez += str;
...
function lorem_ipsum_books_media_store_round_number(num) {
	"use strict";
...
function lorem_ipsum_books_media_store_clear_number(num) {
	"use strict";
	var precision = arguments[1] ? arguments[1] : 0;
...
function lorem_ipsum_books_media_store_sort_array(thearray)  {
	"use strict";
		...
		.on('click', 'tbody .iColorPicker_moreColors', function(e){
			...
			if (thead.hasClass('more_colors')) {
				...
				while (rgb[0]<0xF || rgb[1]<0xF || rgb[2]<0xF) {
					...
					i++;
					out += '<td style="background-color:'+lorem_ipsum_books_media_store_components2hex(rgb[0]*16+rgb[0],rgb[1]*16+rgb[1],rgb[2]*16+rgb[2])+'">&nbsp;</td>';
					rgb[2]+=3;
					if (rgb[2]>0xF) {
						rgb[1]+=3;
						if (rgb[1]>(j===0 ? 6 : 0xF)) {
...
function lorem_ipsum_books_media_store_del_listbox_item_by_text(box, txt) {
	"use strict";
	for (var i=0; i<box.options.length; i++) {
...
function lorem_ipsum_books_media_store_find_listbox_item_by_value(box, val) {
	"use strict";
	var idx = -1;
	for (var i=0; i<box.options.length; i++) {
		if (box.options[i].value == val) {
...
function lorem_ipsum_books_media_store_find_listbox_item_by_text(box, txt) {
	"use strict";
	var idx = -1;
	for (var i=0; i<box.options.length; i++) {
		if (box.options[i].text == txt) {
...
function lorem_ipsum_books_media_store_select_listbox_item_by_value(box, val) {
	"use strict";
	for (var i = 0; i < box.options.length; i++) {
...
function lorem_ipsum_books_media_store_select_listbox_item_by_text(box, txt) {
	"use strict";
	for (var i = 0; i < box.options.length; i++) {
...
function lorem_ipsum_books_media_store_get_listbox_values(box) {
	"use strict";
...
function lorem_ipsum_books_media_store_get_listbox_texts(box) {
	"use strict";
	var delim = arguments[1] ? arguments[1] : ',';
	var str = '';
	for (var i=0; i<box.options.length; i++) {
...
function lorem_ipsum_books_media_store_sort_listbox(box)  {
	"use strict";
...
function lorem_ipsum_books_media_store_get_listbox_selected_index(box) {
	"use strict";
	for (var i = 0; i < box.options.length; i++) {
...
function lorem_ipsum_books_media_store_get_listbox_selected_value(box) {
	"use strict";
	for (var i = 0; i < box.options.length; i++) {
		if (box.options[i].selected) {
...
function lorem_ipsum_books_media_store_get_listbox_selected_text(box) {
	"use strict";
	for (var i = 0; i < box.options.length; i++) {
		if (box.options[i].selected) {
...
function lorem_ipsum_books_media_store_get_listbox_selected_option(box) {
	"use strict";
	for (var i = 0; i < box.options.length; i++) {
		if (box.options[i].selected) {
...
function lorem_ipsum_books_media_store_get_radio_value(radioGroupObj) {
	"use strict";
...
function lorem_ipsum_books_media_store_set_radio_checked_by_num(radioGroupObj, num) {
	"use strict";
	for (var i=0; i < radioGroupObj.length; i++)
...
function lorem_ipsum_books_media_store_set_radio_checked_by_value(radioGroupObj, val) {
	"use strict";
	for (var i=0; i < radioGroupObj.length; i++)
...
/*
// Usage example:
var error = lorem_ipsum_books_media_store_form_validate(jQuery(form_selector), {				// -------- Options ---------
...
function lorem_ipsum_books_media_store_form_validate(form, opt) {
	"use strict";
	var error_msg = '';
...
function lorem_ipsum_books_media_store_add_hidden_elements_handler(key, handler) {
