/**
 * Lorem Ipsum Books & Media Store Framework: Admin scripts
 *
...
jQuery(document).ready(function() {
	...
	jQuery('.widgets_param_post_type_selector').on('change', function() {
		...
		lorem_ipsum_books_media_store_admin_fill_categories(this, cat_fld, cat_lbl);
		return false;
	});
	// Set parent course
	jQuery('.lorem_ipsum_books_media_store_course_selector').on('click', function(e) {
		"use strict";
...
function lorem_ipsum_books_media_store_admin_fill_categories(fld, cat_fld, cat_lbl) {
	"use strict";
	var cat_value = lorem_ipsum_books_media_store_get_listbox_selected_value(cat_fld.get(0));
