...
if ( !function_exists( 'lorem_ipsum_books_media_store_template_matches_2_theme_setup' ) ) {
	add_action( 'lorem_ipsum_books_media_store_action_before_init_theme', 'lorem_ipsum_books_media_store_template_matches_2_theme_setup', 1 );
	function lorem_ipsum_books_media_store_template_matches_2_theme_setup() {
		lorem_ipsum_books_media_store_add_template(array(
			'layout' => 'matches-2',
			'template' => 'matches-2',
			'mode'   => 'matches',
			'title'  => esc_html__('Matches /Style 2/', 'lorem-ipsum-books-media-store'),
...
// Template output
if ( !function_exists( 'lorem_ipsum_books_media_store_template_matches_2_output' ) ) {
	function lorem_ipsum_books_media_store_template_matches_2_output($post_options, $post_data) {
		$show_title = true;
