...
if ( !function_exists( 'lorem_ipsum_books_media_store_template_services_5_theme_setup' ) ) {
	add_action( 'lorem_ipsum_books_media_store_action_before_init_theme', 'lorem_ipsum_books_media_store_template_services_5_theme_setup', 1 );
	function lorem_ipsum_books_media_store_template_services_5_theme_setup() {
		lorem_ipsum_books_media_store_add_template(array(
			'layout' => 'services-5',
			'template' => 'services-5',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 5/', 'lorem-ipsum-books-media-store'),
...
// Template output
if ( !function_exists( 'lorem_ipsum_books_media_store_template_services_5_output' ) ) {
	function lorem_ipsum_books_media_store_template_services_5_output($post_options, $post_data) {
					...
					<div class="sc_services_item_description">
						...
						if ($post_data['post_protected']) {
							...
							if (!empty($post_data['post_link']) && !lorem_ipsum_books_media_store_param_is_off($post_options['readmore'])) {
								?><a href="<?php echo esc_url($post_data['post_link']); ?>" class="sc_services_item_readmore"><?php lorem_ipsum_books_media_store_show_layout($post_options['readmore']); ?><span class="icon-right"></span></a><?php
							}
						}
						?>
					</div>
