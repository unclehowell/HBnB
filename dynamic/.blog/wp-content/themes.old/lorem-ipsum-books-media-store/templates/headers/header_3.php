...
if ( !function_exists( 'lorem_ipsum_books_media_store_template_header_3_theme_setup' ) ) {
	add_action( 'lorem_ipsum_books_media_store_action_before_init_theme', 'lorem_ipsum_books_media_store_template_header_3_theme_setup', 1 );
	function lorem_ipsum_books_media_store_template_header_3_theme_setup() {
		lorem_ipsum_books_media_store_add_template(array(
			'layout' => 'header_3',
			'mode'   => 'header',
			'title'  => esc_html__('Header 3', 'lorem-ipsum-books-media-store'),
			'icon'   => lorem_ipsum_books_media_store_get_file_url('templates/headers/images/3.jpg')
			));
	}
}

// Template output
if ( !function_exists( 'lorem_ipsum_books_media_store_template_header_3_output' ) ) {
	function lorem_ipsum_books_media_store_template_header_3_output($post_options, $post_data) {
		...
		<header class="top_panel_wrap top_panel_style_3 scheme_<?php echo esc_attr($post_options['scheme']); ?>">
			<div class="top_panel_wrap_inner top_panel_inner_style_3 top_panel_position_<?php echo esc_attr(lorem_ipsum_books_media_store_get_custom_option('top_panel_position')); ?>">
