...
if ( !function_exists( 'lorem_ipsum_books_media_store_template_services_2_theme_setup' ) ) {
	add_action( 'lorem_ipsum_books_media_store_action_before_init_theme', 'lorem_ipsum_books_media_store_template_services_2_theme_setup', 1 );
	function lorem_ipsum_books_media_store_template_services_2_theme_setup() {
		lorem_ipsum_books_media_store_add_template(array(
			'layout' => 'services-2',
			'template' => 'services-2',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 2/', 'lorem-ipsum-books-media-store'),
			'thumb_title'  => esc_html__('Small service image (crop)', 'lorem-ipsum-books-media-store'),
			'w'		 => 80,
			'h'		 => 80
		));
	}
...
// Template output
if ( !function_exists( 'lorem_ipsum_books_media_store_template_services_2_output' ) ) {
	function lorem_ipsum_books_media_store_template_services_2_output($post_options, $post_data) {
