...
//==============================================
function lorem_ipsum_books_media_store_theme_scroll_actions() {
	"use strict";
...
//==============================================
function lorem_ipsum_books_media_store_theme_resize_actions() {
	"use strict";
...
//=====================================================
function lorem_ipsum_books_media_store_theme_sc_init(cont) {
	"use strict";
...
function lorem_ipsum_books_media_store_theme_init_post_formats() {
	...
	//if (LOREM_IPSUM_BOOKS_MEDIA_STORE_STORAGE['input_hover'])
	//	jQuery('form:not([class*="cp_cff_"]):not([class*="sc_input_hover_"])').addClass('sc_input_hover_'+LOREM_IPSUM_BOOKS_MEDIA_STORE_STORAGE['input_hover']);
