...
if (!function_exists ('api_pv_register_settings')) {
    function api_pv_register_settings() {
        ...
        add_settings_field(
            ...
            'api-pv-settings',
            'api_pv_video_display_section',
            [ 'id' => 'api_pv_featured_video', 'label' => 'With this option you can include the videos in your image gallery so users can scroll through and watch videos in product image area of your product pages.<br /><span style="color: red;">May Not Work with Some Themes</span>' ]
        );
        ...
        add_settings_field(
            'api_pv_allow_full_fb',
            esc_html__('Allow Full Width and Height - Facebook', 'product-videos-for-woocommerce'),
            'api_pv_check_box_callback',
            'api-pv-settings',
            'api_pv_video_display_section',
            [ 'id' => 'api_pv_allow_full_fb', 'label' => 'Much of the time Facebook videos are not a traditional width and height because of factors like being filmed with cell phone.  If you have a large amount of Facebook videos that do not look correct with the above settings, you may want to allow full width and height for Facebook videos.' ]
        );
