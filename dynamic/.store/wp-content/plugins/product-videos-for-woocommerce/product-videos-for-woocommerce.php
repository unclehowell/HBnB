 ...
 * Description:       Manually of automatically search, find and embed videos for all the products you sell. Embed them in the Woocommerce Image Gallery or a custom tab. Get videos from sites like YouTube, Vimeo, Facebook and more.
 * Version:           2.0.0
 * Author:            ApiGenius.io
...
// Other Plugins
if (!function_exists ('api_pv_other_plugins')) {
	function api_pv_other_plugins() {
	   add_submenu_page('api-pv-dashboard', 'Other Great Plugins', 'Other Plugins','manage_woocommerce', 'other-plugins', 'api_pv_other_plugins_callback');
	}
	add_action('admin_menu', 'api_pv_other_plugins');
}
if (!function_exists ('api_pv_other_plugins_callback')) {
	function api_pv_other_plugins_callback() {
