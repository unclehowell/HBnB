...
/**
 * @snippet       Hide product image - no idea where this script came from
 */
 

add_filter('woocommerce_single_product_function iconic_remove_featured_on_single
image_thumbnail_html', 'remove_featured_image', 2);
