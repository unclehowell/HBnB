...
<?php if ( bbp_current_user_can_access_anonymous_user_form() ) : ?>
	...
	<fieldset class="bbp-form">
		...
		<p>
			<label for="bbp_anonymous_author"><?php _e( 'Name (required):', 'lipi' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_email"><?php _e( 'Mail (will not be published) (required):', 'lipi' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_website"><?php _e( 'Website:', 'lipi' ); ?></label><br />
