...
<div class="bbp-forum-header">
	...
	<span class="bbp-reply-post-date"><a href="<?php bbp_forum_permalink(); ?>" class="bbp-reply-permalink"><i class="fa fa-link"></i></a><?php printf( __( 'Last updated %s', 'lipi' ), bbp_get_forum_last_active_time() ); ?></span>

		<?php do_action( 'bbp_theme_before_forum_title' ); ?>

		<h3><?php _e( 'Forum: ', 'lipi' ); ?><a href="<?php bbp_forum_permalink(); ?>"><?php bbp_forum_title(); ?></a></h3>
