...
copyright = u'2019, Wave Telecom Limited'
author = u'Wave Telecom Limited'
...
latex_documents = [
    (master_doc, 'wave-organisation-whitepaper.tex', u'Wave Whitepaper',
     u'Author(s): Wave Telecom Limited', 'manual'),
]


# -- Options for manual page output My Passport ------------------------------------------
...
texinfo_documents = [
    (master_doc, 'wave-organisation-whitepaper', u'Wave Whitepaper',
     author, 'wave-organisation-whitepaper', 'Free Internet',
     'manual'),
]
...
extlinks = {'Store': ('https://wave.hotspotbnb.com/store/%s',
                      'Store')}